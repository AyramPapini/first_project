...
while opcao != 0:
    ...
    if opcao == 1:
        ...
        if opcaomat == 1:
            while num != 0:
                ...
                num = int(input('\nDigite 1 para fazer uma nova operação ou 0 para Retornar: '))
        if opcaomat == 2:
            while num != 0:
                num1 = int(input('Digite um número: '))
                num2 = int(input('Digite outro número: '))
    ...
    if opcao == 5:
        while num != 0:
            escmedida = int(input('Selecione a unidade a ser convertida \n[1]Comprimento\n[2]Massa\n[3]Tempo\n[4]Temperatura\n'))
            
            # Laço para converter Comprimento
            
            if escmedida == 1:
                comp1 = int(input('Deseja converter de \n[1] Milimetro\n[2] Centímetro\n[3] Decimetro\n[4] Metro\n[5] Decâmetro\n[6] Hectometro\n[7] Quilometro\n'))
                comp2 = int(input('Para \n[1] Milimetro\n[2] Centímetro\n[3] Decimetro\n[4] Metro\n[5] Decâmetro\n[6] Hectometro\n[7] Quilometro\n'))
            ...
            # Laço para converter Tempo
                ...
                tempo1 = int(input('Deseja converter de \n[1] Segundos\n[2] Minutos\n[3] Horas\n[4] Dias\n[5] Semanas\n[6] Meses\n[7] Anos\n'))
                tempo2 = int(input('Para \n[1] Segundos\n[2] Minutos\n[3] Horas\n[4] Dias\n[5] Semanas\n[6] Meses\n[7] Anos\n'))
